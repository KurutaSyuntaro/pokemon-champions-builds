...
SPRITE_ID: dict[str, int] = {
    ...
    "メガギャラドス": 10041,
    "スコヴィラン": 952,
    "メガスコヴィラン": 952,  # ポケモンチャンピオンズ独自メガ（PokeAPI未登録のため通常フォーム使用）
    "オオニューラ": 903,
    "ワルビアル": 553,
    "エーフィ": 196,
    "エアームド": 227,
...
SOCIAL_LINKS = [
    ...
    ("Zenn", "https://zenn.dev/kuruta_syuntaro",
     '<svg viewBox="0 0 24 24"><path d="M.264 23.771h4.984c.264 0 .498-.147.645-.352L19.614.874c.176-.293-.029-.645-.381-.645h-4.72c-.235 0-.44.117-.587.323L.03 23.361c-.088.176.029.41.234.41zM17.445 23.419l6.479-10.408c.176-.293-.029-.645-.381-.645h-4.72c-.235 0-.44.117-.586.323l-6.479 10.408c-.176.293.029.645.381.645h4.72c.234 0 .44-.117.586-.323z"/></svg>'),
]
